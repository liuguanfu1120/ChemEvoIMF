...
| IMF             | numpy arrray or str | Msun, 1 | (N, 2) or 1 | The first column is the initial mass, while the second is the IMF. If it is a string, it should be either of 'Salpeter', 'Chabrier', 'Kroupa', 'PowerLaw' (with power index provided) or 'DietSalpeter'.                                                                                                                                                                     |
| StellarMass     | numpy arrray        | Msun    | N           | StellarMass[i] is the stellar mass just after Age[i]                                                                                                                                                                                                                                                                                                                         |